...
<ScrollView style={styles.scrollableStandalone} showsVerticalScrollIndicator={false}>

<TouchableOpacity onPress={() => handleCopyToClipboard(addressText)}>
  <Card style={styles.cardBoxStandalone}>
    <Card.Title
      title="Shipping Address (Air)"
      left={(props) => <AirShippingAddressIcon {...props} />}
      titleStyle={styles.cardTitle}
    />
    <Card.Content style={styles.cardContentStandalone}>
...
<TouchableOpacity onPress={() => handleCopyToClipboard(addressText)}>
  <Card style={styles.cardBoxStandalone}>
    <Card.Title
      title="Shipping Address (Sea)"
      left={(props) => <SeaShippingAddressIcon {...props} />}
      titleStyle={styles.cardTitle}
    />
    <Card.Content style={styles.cardContentStandalone}>
      <Paragraph style={styles.paragraph}>
...
<TouchableOpacity onPress={() => handleCopyToClipboard("456 Elm Street, Downtown, Los Angeles, CA 90001")}>
  <Card style={styles.cardBoxStandalone}>
    <Card.Title
      title="Pickup Branch"
      left={(props) => <AddressIcon {...props} />}
      titleStyle={styles.cardTitle}
    />
    <Card.Content style={styles.cardContentStandalone}>
      <Paragraph style={styles.paragraph}>
        456 Elm Street, Downtown, Los Angeles, CA 90001
      </Paragraph>
    </Card.Content>
  </Card>
</TouchableOpacity>
